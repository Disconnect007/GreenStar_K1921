...
/**
  ...
  * @param   FSFrq  Желаемое значение частоты в ГЦ
  * @param   I2CFrq  Значение частоты  тактового сигнала I2C в ГЦ
  * @retval  void
  */
void I2C_FSFreqConfig(uint32_t FSFrq, uint32_t I2CFrq)
{
    uint32_t freq_calc = I2CFrq / (4 * FSFrq);
...
/**
  ...
  * @param   HSFrq  Желаемое значение частоты в ГЦ
  * @param   I2CFrq  Значение частоты  тактового сигнала I2C в ГЦ
  * @retval  void
  */
void I2C_HSFreqConfig(uint32_t HSFrq, uint32_t I2CFrq)
{
    uint32_t freq_calc = I2CFrq / (3 * HSFrq);
